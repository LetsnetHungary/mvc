        ...
        public function loginAttemptUser(CoreApp\AttemptUser $a) {
          if($this->checkIfUserLoggedIn()) {
            ...
            if($result = $stmt->fetchAll(PDO::FETCH_ASSOC)){
              ...
              CoreApp\Session::init();
              CoreApp\Session::set("logged_user", $a->e);
              CoreApp\Session::set("devicekey", $a->devicekey);
              CoreApp\Session::set("allow", $result[0]["allow"]);
              CoreApp\Session::set("webpage", $result[0]["webshopdb"]);
              CoreApp\Session::set("uniquekey", $result[0]["uniquekey"]);
